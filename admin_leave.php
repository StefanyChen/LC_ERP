        ...
        <div style="margin-left:10px">
         <p style="font-size:18px;font-family:Microsoft JhengHei">未簽核名單</p>
          ...
          <tr>
            ...
            person=<?php echo $row['id'];?> name=<?php echo $row['l_name'];?> startDate=<?php echo $row['l_startDate'];?> endDate=<?php echo $row['l_endDate'];?> startTime=<?php echo $row['l_startTime'];?> endTime=<?php echo $row['l_endTime'];?> type=<?php echo $row['l_type'];?> hrs=<?php echo $row['l_hrs'];?> hrCheck=<?php $row['l_hrCheck']?>>
            ...
            <?php if($row["l_hrCheck"]=='簽核中') {?>
              ...
              <i class="material-icons" style="font-size:15px">check</i></a></td>
              <td style="width:35px"  class="fancybox" id="cancleCkeck"   person=<?php echo $row['id'];?> name=<?php echo $row['l_name'];?> startDate=<?php echo $row['l_startDate'];?> endDate=<?php echo $row['l_endDate'];?> startTime=<?php echo $row['l_startTime'];?> endTime=<?php echo $row['l_endTime'];?> type=<?php echo $row['l_type'];?> hrs=<?php echo $row['l_hrs'];?>><!--<a href="../Controller/leave_bossCheck.php?id=<?php echo $row["id"]; ?>">-->
...
<script type="text/javascript">
    $(document).ready(function() {
        $('td#cancleCkeck').click(function(evt) {
         ...
         $.fancybox({
          'type':'ajax',
          'href':'box.php?id='+id+'&startTime='+startTime+'&startDate='+startDate+'&endDate='+endDate+'&endTime='+endTime+'&hrs='+hrs+'&type='+type+'&name='+name+'&hrCheck='+hrCheck
          });
        });
    });
