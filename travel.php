...
<body>
	...
	<div class="right-up">
		...
		<p class="p">預計出發日期: <input type="text" id="from" name="from"></p>
		<p class="p">預計結束日期: <input type="text" id="to" name="to"></p>
		<p class="p">出差類型:<input type="radio" name="b_type" value="">國內   <input type="radio" name="b_type" value="">國外</p>
		<p class="p">交通需求:<input type="radio" name="transport" value="">火車   <input type="radio" name="transport" value="" >飛機   <input type="radio" name="transport" value="" >高鐵   <input type="radio" name="transport" value="">其他 <input type="text" size="5" name="trans_other" value=""> </p>
		<p class="p">出差地點: <input type="text" name="" size="15" placeholder="ex:台北市信義區"></p>
		<p class="p">出差事由: <input type="text" name="" size="70" placeholder="請輸入詳細說明"></p>
